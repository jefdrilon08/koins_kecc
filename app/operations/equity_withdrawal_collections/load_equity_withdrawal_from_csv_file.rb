module EquityWithdrawalCollections  
  class LoadEquityWithdrawalFromCsvFile
    ...
    def recompute_totals!
      @equity_withdrawal_collection = EquityWithdrawalCollection.find(@equity_withdrawal_collection.id)
        ...
        data  = ::EquityWithdrawalCollections::RecomputeTotals.new(
                  config: r_config
                ).execute!

        @equity_withdrawal_collection.update!(data: data)
