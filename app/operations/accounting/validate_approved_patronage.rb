module Accounting
  class ValidateApprovedPatronage < AppValidator
    ...
    def execute!
      ...
      if @data_store.data["patronage_interest_amount"].to_f.round(2) == 0.00
        @errors[:messages] << {
          key: "total_interest_paid_amount",
          message: "No interest amount"
        }
      end
