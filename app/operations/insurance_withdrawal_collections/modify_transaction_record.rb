  ...
  class ModifyTransactionRecord
    ...
    def execute!
      ...
      ActivityLog.create!(
        ...
        data: {
          user_id: @user.id,
          withdrawal_collection_id: @insurance_withdrawal_collection.id,
    ...
    def construct_log_message!
      ...
      content = "#{@user.full_name} modified insurance withdrawal amount from #{@original_amount} to #{@current_transaction[:amount]} of #{@current_transaction[:account_subtype]}) of member #{member.full_name}"
