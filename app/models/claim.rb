class Claim < ApplicationRecord
  ...
  GENDER = ["MALE","FEMALE"]
  CREDITORS_NAME_FULL = ["KABUHAYAN SA GANAP NA KASARINLAN CREDIT AND SAVINGS COOPERATIVE", "CEBU ARCHDIOCESAN PROGRAM FOR SELF RELIANCE INC.-CAPS-R", "CAPS-R INC", "KASAGANA-KA EMPLOYEE-EMPLOYER'S PROVIDENT FUND ASSOCIATION INC."]
