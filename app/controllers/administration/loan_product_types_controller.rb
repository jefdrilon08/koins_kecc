module Administration
  class LoanProductTypesController < ApplicationController
    before_action :authenticate_user!
    before_action :authenticate_admin!

    def new
      @loan_product = LoanProduct.find(params[:loan_product_id])
      @loan_product_type = LoanProductType.new
    ...
    def create
      @loan_product = LoanProduct.find(params[:loan_product_id])
      @loan_product_type = LoanProductType.new(loan_product_type_params)
    ...
    def edit
      @loan_product = LoanProduct.find(params[:loan_product_id])
      @loan_product_type = LoanProductType.find(params[:id])
    ...
    def loan_product_type_params
      params.require(:loan_product_type).permit!
    end
  end
end
