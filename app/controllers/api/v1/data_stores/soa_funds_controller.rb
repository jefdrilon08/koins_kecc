module Api
  module V1
    module DataStores
      class SoaFundsController < ActionController::Base
        ...
        def fetch
          ...
          if record.blank?
            ...
            # Get officers
            record.data["officers"] = records.map{ |o| o[:officer] }.uniq
        ...
        def queue
          data_store_type = params[:data_store_type] || "SOA_FUNDS"
          ...
          errors  = ::DataStores::ValidateSoaFundsQueue.new(
                      config: {
                        branch: branch,
          ...
          if errors[:messages].size == 0
            record  = DataStore.soa_funds.where(
            ...
            ProcessSoaFunds.perform_later(args)
