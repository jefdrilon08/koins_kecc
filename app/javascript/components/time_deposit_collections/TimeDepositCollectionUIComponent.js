...
import TimeDepositCollectionUITable from './TimeDepositCollectionUITable';
import AccountingEntryPreview from '../accounting/AccountingEntryPreview';
import AddRecord from './AddRecord';
import {numberWithCommas} from '../utils/helpers';

export default class TimeDepositCollectionUIComponent extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    this.fetchTimeDepositCollectionData();
  }

  fetchTimeDepositCollectionData() {
    var context = this;

    $.ajax({
      url: "/api/v1/time_deposit_collections/fetch",
      method: 'GET',
      data: {
        id: this.props.id
      },
      ...
      error: function(response) {
        ...
        alert("Error in fetching time_deposit_collection");
      }
    });
  }
  ...
  saveParticular() {
    ...
    $.ajax({
      url: "/api/v1/time_deposit_collections/update_particular",
      method: 'POST',
      data: {
  ...
  saveOrNumber() {
    ...
    $.ajax({
      url: "/api/v1/time_deposit_collections/update_or_number",
      method: 'POST',
      data: {
        id: context.state.data.id,
        authenticity_token: context.props.authenticityToken,
  ...
  saveSiNumber() {
    ...
    $.ajax({
      url: "/api/v1/time_deposit_collections/update_si_number",
      method: 'POST',
      data: {
        id: context.state.data.id,
        authenticity_token: context.props.authenticityToken,
  ...
  saveArNumber() {
    ...
    $.ajax({
      url: "/api/v1/time_deposit_collections/update_ar_number",
      method: 'POST',
      data: {
        id: context.state.data.id,
        authenticity_token: context.props.authenticityToken,
