...
document.addEventListener('DOMContentLoaded', function() {
  var printButton = document.getElementById('btn-print-soax');
  var downloadButton = document.getElementById('btn-print-excelsoax');
  ...
  if (downloadButton) {
    downloadButton.addEventListener('click', function() {
      ...
      link.setAttribute("download", "SOA_Expenses"); 
