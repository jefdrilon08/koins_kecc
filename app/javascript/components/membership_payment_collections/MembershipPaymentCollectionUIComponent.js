...
export default class MembershipPaymentCollectionUIComponent extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    this.fetchMembershipPaymentCollectionData();
  }

  fetchMembershipPaymentCollectionData() {
    var context = this;

    $.ajax({
      url: "/api/v1/membership_payment_collections/fetch",
      method: 'GET',
      data: {
        id: this.props.id
      },
      ...
      error: function(response) {
        ...
        alert("Error in fetching membership_payment_collection");
      }
    });
  }
  ...
  saveParticular() {
    ...
    $.ajax({
      url: "/api/v1/membership_payment_collections/update_particular",
      method: 'POST',
      data: {
  ...
  saveOrNumber() {
    ...
    $.ajax({
      url: "/api/v1/membership_payment_collections/update_or_number",
      method: 'POST',
      data: {
        id: context.state.data.id,
        authenticity_token: context.props.authenticityToken,
  ...
  saveArNumber() {
    ...
    $.ajax({
      url: "/api/v1/membership_payment_collections/update_ar_number",
      method: 'POST',
      data: {
        id: context.state.data.id,
        authenticity_token: context.props.authenticityToken,
