...
export default class AccountingEntryComponent extends React.Component {
  ...
  render() {
    if (this.state.isLoading) {
      ...
      var for_full_payment = this.state.data.data.for_full_payment.reference_number;
      var for_full_paymentapproved = this.state.data.data.accounting_entry.approved_by;
      var approved_by_fullpayment = this.state.data.data.for_full_payment.approved_by;
