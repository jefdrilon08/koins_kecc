...
var Index = (function() {
  ...
  var urlCreateInsuranceWithdrawalCollection  = "/api/v1/insurance_withdrawal_collections";
  ...
  var _bindEvents = function() {
    ...
    $btnConfirmNewTransaction.on("click", function() {
      ...
      $.ajax({
        url: urlCreateInsuranceWithdrawalCollection,
        method: 'POST',
        data: {
        ...
        success: function(response) {
          ...
          window.location.href="/insurance_withdrawal_collections/" + response.id;
        },
