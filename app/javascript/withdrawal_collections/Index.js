...
var Index = (function() {
  ...
  var urlCreateWithdrawalCollection = "/api/v1/withdrawal_collections";
  ...
  var _bindEvents = function() {
    ...
    $btnConfirmNewTransaction.on("click", function() {
      ...
      $.ajax({
        url: urlCreateWithdrawalCollection,
        method: 'POST',
        data: {
        ...
        success: function(response) {
          ...
          window.location.href="/withdrawal_collections/" + response.id;
        },
...
window.WithdrawalCollectionsIndex = Index;
